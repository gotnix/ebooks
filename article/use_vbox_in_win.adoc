...
gcc gcc-c++ iftop iotop iptraf jemalloc-devel.x86_64 ldns libaio-devel.x86_64 \
lrzsz make man nc ncurses-devel.x86_64 nmap nmon openssh-clients pigz qperf \
sysstat.x86_64 tcpdump tmux tree vim-enhanced wget wqy-zenhei-fonts-common.noarch \
