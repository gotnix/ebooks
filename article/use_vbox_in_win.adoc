...
lrzsz lsof make man mlocate mtr nc ncurses-devel.x86_64 nload nmap nmon OpenIPMI openssh-clients \
pciutils pigz powertop qperf sdparm smartmontools sysstat tcpdump tmux tree unzip usbutils vim-enhanced \
wget wqy-zenhei-fonts-common.noarch wqy-zenhei-fonts.noarch xorg-x11-fonts-75dpi xorg-x11-xauth xterm xz
