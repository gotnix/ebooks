...
pciutils perf pigz powertop qperf sdparm smartmontools strace sysstat tcpdump tmux tree unzip usbutils \
vim-enhanced wget wqy-zenhei-fonts.noarch xorg-x11-fonts-75dpi xorg-x11-xauth xterm xz
